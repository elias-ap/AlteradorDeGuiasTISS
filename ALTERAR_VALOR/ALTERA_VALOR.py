...
do_data_alteration = 'n'  # input('You want to do data alterations? Write Y(yes) or N(no):\n')
do_value_alteration = 'y'  # input('You want to do values alterations? Write Y(yes) or N(no):\n')
